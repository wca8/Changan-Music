...
export const CHANGE_SIMI_PLAY_LIST='player/CHANGE_SIMI_PLAY_LIST'
export const CHANGE_IS_PLAYING_MUSIC='player/CHANGE_IS_PLAYING_MUSIC'
export const CHANGE_FIRST_ENTRY='player/CHANGE_FIRST_ENTRY'